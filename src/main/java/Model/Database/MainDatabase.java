...
public class MainDatabase {
    ...
    public void deleteeStudendefwght(String emailOrId) throws SQLException {
        ...
        pst = databaseConnection.connection.prepareStatement("Delete From student and stumarks where email = ? OR id = ?");
    ...
    public ResultSet deleteStudent(String emailOrId) throws SQLException{
        PreparedStatement pst = null;
        pst = databaseConnection.connection.prepareStatement("Delete From student where email = ? OR id = ?");
        ResultSet resultSet = pst.executeQuery();
        return resultSet;
    }
}