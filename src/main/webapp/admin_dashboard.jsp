...
<div class="d-flex justify-content-center h-25">
    <center>
    <!-- Employees -->
        <br><label><b><h1>Lectures</h1></b></label></br>

        <a href="admin_add_employee.jsp" class="btn btn-primary" role="button">Add Lecture</a> <!-- Works -->
        <a href="admin_del_student.jsp" class="btn btn-primary" role="button">Delete Lecture</a>
        <a href="admin_view_employee.jsp" class="btn btn-primary" role="button">View Lectures</a><br> <!--Works -->
